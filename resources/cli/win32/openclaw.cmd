...
if /i "%1"=="update" (
    echo openclaw is managed by 阿山 ^(bundled version^).
    echo.
    echo To update openclaw, update 阿山:
    echo   Open 阿山 ^> Settings ^> Check for Updates
